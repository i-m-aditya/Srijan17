 ...
 */
public class OnlineEvents extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        framentView= inflater.inflate(R.layout.fragment_online_events, container, false);
        return framentView;
    }
    ...
    private void layout_start(){
        LinearLayout hundred_seconds=(LinearLayout) framentView.findViewById(R.id.hundred_seconds);
