...
public class MusicEvents extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        framentView=inflater.inflate(R.layout.fragment_music_events, container, false);
        return framentView;
    }
    ...
    private void layout_start(){
        LinearLayout avalanche=(LinearLayout) framentView.findViewById(R.id.avalanche);
        ...
        LinearLayout unplugged=(LinearLayout) framentView.findViewById(R.id.unplugged);
        ...
        LinearLayout aaroh=(LinearLayout) framentView.findViewById(R.id.aaroh);
